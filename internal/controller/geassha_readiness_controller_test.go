...
func TestHAReadinessRequiresConcreteClusterPrerequisites(t *testing.T) {
	...
	cluster := &geassv1alpha1.GeassCluster{ObjectMeta: metav1.ObjectMeta{Name: "default", Namespace: platform.SystemNamespace}, Status: geassv1alpha1.GeassClusterStatus{Conditions: []metav1.Condition{{Type: platform.ConditionAddonsReady, Status: metav1.ConditionTrue}, {Type: platform.ConditionReady, Status: metav1.ConditionTrue}}}}
	readiness := &geassv1alpha1.GeassHAReadiness{ObjectMeta: metav1.ObjectMeta{Name: "platform", Namespace: platform.SystemNamespace}}
	items := []client.Object{cluster, readiness, &storagev1.StorageClass{ObjectMeta: metav1.ObjectMeta{Name: "standard"}}}
	for i := 0; i < 3; i++ {
